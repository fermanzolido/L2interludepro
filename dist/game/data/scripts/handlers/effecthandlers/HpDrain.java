...
public class HpDrain extends AbstractEffect
{
	...
	{
		if (effector.isAlikeDead() || (skill.getId() == 4050) || effector.isAffectedByAbnormalType(AbnormalType.INVINCIBILITY) || effector.isAffectedByAbnormalType(AbnormalType.ABNORMAL_INVINCIBILITY)) // Cubic Skill ID 4050 hardcoded to avoid double damage
		{
			return;
		}
