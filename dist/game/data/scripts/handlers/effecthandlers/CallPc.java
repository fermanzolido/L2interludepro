...
public class CallPc extends AbstractEffect
{
	...
	public static boolean checkSummonTargetStatus(Player target, Player activeChar)
	{
		...
		// Seven Signs Dungeon summoning - Retail behavior.
		// Note: On retail, characters can enter the 7s dungeon with summon friend.
		// The SevenSigns system (in SevenSigns.java) automatically teleports away
		// players who are not eligible based on cabal and period.
		// This check is now removed to match retail behavior - let the automatic
		// teleportation system handle ineligible players.
