	...
	public boolean onCommand(String command, Player activeChar)
	{
		...
		else if (command.startsWith("admin_forge_send "))
		{
			try
			{
				...
				{
					// Note: Client-to-server packet forging is not implemented.
					// The original implementation used GameClientPacket and GamePacketHandler APIs
					// that have been removed or significantly changed in the current version.
					// This functionality is not commonly needed and would require significant refactoring
					// of the packet handling system to support properly.
					// Use "sc" (send to client) or "sb" (send broadcast) methods for packet testing.
					// @formatter:off
					/*bb.flip();
					...
					// @formatter:on
					throw new UnsupportedOperationException("Client-to-server packet forging is not implemented. Use 'sc' or 'sb' methods instead.");
				}
