...
public class Seed implements IItemHandler
{
	...
	public boolean onItemUse(Playable playable, Item item, boolean forceUse)
	{
		...
		// Check if player is in the correct castle tax zone for this seed
		final Player player = playable.asPlayer();
		final org.l2jmobius.gameserver.model.siege.Castle castle = CastleManager.getInstance().getCastle(player);
		final int castleId = (castle != null) ? castle.getResidenceId() : 0;
