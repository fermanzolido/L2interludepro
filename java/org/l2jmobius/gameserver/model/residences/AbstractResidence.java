...
public abstract class AbstractResidence extends ListenersContainer
{
	...
	/**
	 * Sets the name of this residence.
	 * <b>Current implementation (Interlude):</b> Name is loaded from separate tables (e.g., Castle from 'castle' table).
	 * <b>Future refactoring (post-Interlude):</b> When Forts are implemented and both Castles and Forts
	 * are loaded from a unified 'residences' table, name should be set in the constructor via the residence data.
	 * At that point, this setter can be made protected or removed entirely.
	 * @param name the name of the residence
	 * @see org.l2jmobius.gameserver.model.siege.Castle - loads name from 'castle' database table
	 */
