...
public enum Stat
{
	...
	// Note: BUFF_IMMUNITY stat not implemented for Interlude
	// Interlude does not have buff immunity mechanics (no skills/items provide this stat)
	// DEBUFF_IMMUNITY is implemented and used (see Formulas.java lines 1168, 1201, 1300)
	// BUFF_IMMUNITY would prevent beneficial buffs from being applied (opposite of DEBUFF_IMMUNITY)
	// Not needed for retail-like Interlude behavior - uncomment only if custom content requires it
