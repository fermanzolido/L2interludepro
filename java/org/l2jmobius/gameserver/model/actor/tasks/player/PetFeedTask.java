...
public class PetFeedTask implements Runnable
{
	...
	public void run()
	{
		...
		for (int id : foodIds)
		{
			// Mount food must be in player's inventory (not pet inventory)
			// Mounts (Striders, Wyverns) don't have separate inventories in Interlude
			// Only summoned pets (not mounted) have their own inventory
