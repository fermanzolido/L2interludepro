...
public class EventMonster extends Monster
{
	...
	// Event mobs drop items to ground with protection
	// Current implementation: Items are protected for the killer (player who dealt most damage)
	// Note: For spawner-based events (e.g., Rabbits spawned by players), implement
	// a custom drop protection system using event-specific logic in the AI script.
	// The spawner can be tracked via OnCreatureDeath event listener in the script.
