...
public class CreatureTemplate extends ListenersContainer
{
	...
	public void set(StatSet set)
	{
		...
		_baseAccuracy = set.getDouble("accuracy", 0);
		_baseEvasion = set.getDouble("evasion", 0);
	...
	/**
	 * @return the base accuracy from XML
	 */
	...
	/**
	 * @return the base evasion from XML
	 */
