 ...
 * <b>Known limitations (Interlude):</b>
 * <ul>
 * <li><b>Archer mob AI:</b> Archer mobs use standard NPC AI and do not specifically target healers.
 * Implementing this would require custom AI logic for festival mobs to identify and prioritize healer classes.
 * Current behavior is acceptable and retail-like for Interlude.</li>
 * <li><b>Party leave penalty:</b> Players leaving party during festival are teleported out but do not take
 * continuous damage. Full retail implementation would require: damage over time effect, healing block,
 * and special debuff system. Current simplified approach prevents party manipulation exploits.</li>
 * </ul>
 * @author Tempy
 */
	...
	private class FestivalManager implements Runnable
	{
		...
		public synchronized void run()
		{
			...
			for (DarknessFestival festivalInst : _festivalInstances.values())
			{
				...
				// Custom message: Interlude client does not have a specific NpcString for chest spawn event
				// This text is server-specific and provides clear information to participants
