...
public class RequestExAskJoinMPCC extends ClientPacket
{
	...
	{
		// 8871 Strategy Guide - Consumable item that grants Command Channel rights
		// Retail behavior: Item is NOT destroyed on invite, only on successful CC formation
		// Destruction is handled elsewhere when the CC is actually created
		// This check only verifies the player has the right to invite
		hasRight = true;
	}
