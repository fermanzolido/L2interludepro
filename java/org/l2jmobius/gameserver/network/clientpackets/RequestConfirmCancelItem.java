...
public class RequestConfirmCancelItem extends ClientPacket
{
	...
	protected void runImpl()
	{
		...
		// S84 grade items (TOP grade) not available in Interlude
		// Interlude max grade is S80 (price: 920,000 adena)
		// S84 introduced in Gracia+ chronicles (price would be ~3.2M adena)
