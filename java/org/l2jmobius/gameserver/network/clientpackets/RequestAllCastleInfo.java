...
public class RequestAllCastleInfo extends ClientPacket
{
	...
	// Note: Sent here as a convenience when player opens castle info window
	// Also sent on: party member movement, party formation, zone changes
	// Multiple sends are acceptable - ensures party positions stay synchronized
	if (player.isInParty())
	{
