...
public class SystemMessage extends ServerPacket
{
	...
	// SystemMessage parameter types for Interlude
	// Note: Types 14 and 15 are from later chronicles (Goddess of Destruction+):
	// - TYPE_CLASS_ID = 15 (for class name parameters)
	// - Type 14: Unknown/undocumented
	// These types do not exist in Interlude client protocol and are not implemented here
	// Interlude supports types 0-13 only
	// private static final byte TYPE_CLASS_ID = 15;
	// private static final byte TYPE_UNKNOWN = 14;
