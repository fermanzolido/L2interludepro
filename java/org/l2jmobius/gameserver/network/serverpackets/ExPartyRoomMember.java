...
public class ExPartyRoomMember extends ServerPacket
{
	...
	public void writeImpl(GameClient client, WritableBuffer buffer)
	{
		...
		// Instance zone data (Interlude limitation)
		// Value 0: No instance data sent (standard for Interlude)
		// Value 1+: Would send additional instance information (feature from later chronicles)
		// Interlude doesn't have advanced instance systems, so this is always 0
		buffer.writeInt(0);
	}
	}
}
