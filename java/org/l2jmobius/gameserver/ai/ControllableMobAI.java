...
public class ControllableMobAI extends AttackableAI
{
	...
	{
		// Controllable mobs cannot auto-attack NPCs, doors, or summons
		if ((target == null) || target.isNpc() || target.isDoor())
		{
			return false;
		}
		
		// Note: Summons extend Playable, not Npc, so they can be attacked by controllable mobs.
		// If the hierarchy changes in the future (Summon extends Npc), the check above will handle it.
